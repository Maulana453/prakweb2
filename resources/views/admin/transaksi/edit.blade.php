...
<div class="d-flex justify-content-center">
    ...
    <form method="POST" action="{{ url('admin/transaksi/update/'. $prod->id) }}" class="col-sm-6">
        {{ csrf_field() }}
        ...
        <div class="form-group row">
            ...
            <div class="col-8">
                <input id="keterangan" name="keterangan" type="text" value="{{ $prod->keterangan }}" class="form-control" spellcheck="false" data-ms-editor="true">
            </div>
        </div>
        <div class="form-group row">
